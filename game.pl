...
game:-
	...
	new(ChCell, chain),
	maplist(create_cell(W, Counter, Ph, ChCell, Gameboard), LP, LL),
...
create_cell(W, Counter,Phrase, ChCell, Gameboard, Point,  Code) :-
	%char_code(Number, Code),
	Number is 100 - Code,
	new(H, cell(W, Counter, Phrase, Number, Point, Gameboard)),
	send(H, my_draw),
